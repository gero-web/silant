...
SECRET_KEY = 'django-insecure-ce2^vqxdvk*f61*k49^fj)@se+o_&y47+tuxl=2ih)@^vawzhg'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

if DEBUG:
    path = os.path.join(BASE_DIR, 'conf.env')
    load_dotenv( path)
...
INSTALLED_APPS = [
    ...
    'claims_app.apps.ClaimsAppConfig',
    'technique_maintenance_app.apps.TechniqueMaintenanceAppConfig',
